# Experience Princeton — microsite
...
**Experience Princeton's own CDN** supplies the remaining photography: the Nassau
...
The site reuses Experience Princeton's copy and photography, which belong to
...
Experience Princeton logo (orange mark on light, the white/orange horizontal
lockup on dark).
